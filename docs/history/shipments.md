...
made COMPASS a task router with explicit ownership; moved full shipment/research/UX records behind a
history index while preserving old entry paths. Corrected provider-independence, compiler-input,
calibration, nutrition, and verified spec-status drift. Updated docs-sweep/whats-next and the tracker
adapter to follow current authority. Adopted the owner's existing Codex-only workflow helper changes
and verified their existing regression seams (old scripts fail the new start guard; updated scripts pass).

Evidence base: integrated `deaaaa8`, source/routes/tests, and GitHub's open PR inventory (PR #109).
README structure was informed by [Actual](https://github.com/actualbudget/actual) and
[Immich](https://github.com/immich-app/immich): a direct product statement, compact capability entry,
and separate development documentation. No personal runtime data was used for public images.

Primary-checkout edits were preserved. Remaining groups are source-comment rationale (MA-7),
immutable-plan edits to exclude (MA-6), and unique untracked research to retain/adjudicate. SR-1/2
remain the leading correctness work; this documentation task does not claim to fix them or validate
training effectiveness. App metadata remains the unclosed part of MA-8.
...
remain unchanged. See the [maintainer audit](../reviews/2026-09-05-maintainer-audit.md).

---

## FR-3 / FR-4 core-journey audit and selection (2026-09-01)

The [accepted FR-3 audit](../reviews/2026-09-01-fr3-core-journey-audit.md) exercised Today → Plan
...
[design](../superpowers/specs/2026-09-01-fr13-early-end-retrospective-window-design.md) and
[implementation plan](../superpowers/plans/2026-09-01-fr13-early-end-retrospective-window.md)
...
- **Evidence:** [FR3-01](../reviews/2026-09-01-fr3-core-journey-audit.md#fr3-01--early-end-narrative-grades-the-unlived-future)
- **Design:** [accepted design](../superpowers/specs/2026-09-01-fr13-early-end-retrospective-window-design.md)
- **Plan:** [implementation plan](../superpowers/plans/2026-09-01-fr13-early-end-retrospective-window.md)
- **Acceptance:** [attended verification](../reviews/2026-09-01-fr13-acceptance.md)
...
The approved [design](../superpowers/specs/2026-08-29-fr5-deterministic-authority-design.md) and
[implementation plan](../superpowers/plans/2026-08-29-fr5-deterministic-authority.md) replaced
...
The [acceptance record](../reviews/2026-08-29-fr5-acceptance.md) closes FR-5: five varied
...
The accepted [adversarial investment review](../reviews/2026-08-20-nodevelo-adversarial-investment-review.md)
...
|---|---|
| [Calendar/local divergence](../reviews/2026-08-20-nodevelo-adversarial-investment-review.md#calendar-and-persistence-integrity) | PR #87 commits local state before best-effort calendar mirroring and preserves CAS conflicts. |
| [Unsafe retrospective progression and self-reinforcing AI lessons](../reviews/2026-08-20-nodevelo-adversarial-investment-review.md#retrospective-and-turnover) | PRs #92/#94 separate deterministic closeout facts, optional AI prose, and explicitly adopted future seeds/reflections. |
| [Named-segment false credit](../reviews/2026-08-20-nodevelo-adversarial-investment-review.md#named-segments-and-intent-parsing) | PR #96 makes the authoritative labelled lane deterministic and scored from matched interval evidence; the simpler adjacent-zone grading contract remains an explicit deferred decision. |
| [Publishable structural/safety hazards](../reviews/2026-08-20-nodevelo-adversarial-investment-review.md#plan-safety-and-claudes-authority) | PR #97 adds the persisted publication gate: blockers refuse, preferences require acknowledgment, advisories remain informational. |
| [Silent stale physiology](../reviews/2026-08-20-nodevelo-adversarial-investment-review.md#intervalsicu-ownership-privacy-and-recovery) | PR #101 exposes freshness, permits temporary sync failure with last-valid data, and blocks missing, malformed, inconsistent, or obsolete physiology. |
| [Causal claims, redundant AI criticism, Ask Coach, and privacy ambiguity](../reviews/2026-08-20-nodevelo-adversarial-investment-review.md#disable-remove-or-rewrite) | PR #103 removes causal/injury-risk product claims and Ask Coach, replaces the narrative critic with deterministic overview checks, labels retained AI prose, and separates local persistence from remote Anthropic processing. |
...
its [evidence entry](../reviews/2026-08-24-publication-gate-evidence.md#2026-08-28--fr-1-current-code-synthetic-four-week-generation)
...
- **Calendar trust contract (PR #87, merged 2026-08-22):** `persistMirroredMove`
  ...
  *before* any Intervals.icu network call ([INVARIANTS #8](../INVARIANTS.md)), aborts with
  `versionConflict` when the block was concurrently deleted or replaced (morning-check surfaces the
  409 instead of consuming the check — [INVARIANTS #7](../INVARIANTS.md)), and overlays freshly
...
- **Retrospective turnover trust contract (PR #92, merged 2026-08-23):** closeout is
  ...
  **Deferred:** the live LLM smoke run for the changed retrospective paths is owed at the next real
  block turnover — see [RECIPES § block turnover](../RECIPES.md#turn-over-a-block-end--retrospective--next-block).
...
- **Publication gate (PR #97, merged 2026-08-23):** `lib/publication-gate.ts` classifies validator
  ...
  log](../reviews/2026-08-24-publication-gate-evidence.md).
...
- **Residual gap surfaced by that same live run, explicitly out of NV-2's scope:** the range scored
  ...
  [02-scoring-and-learning.md](../systems/02-scoring-and-learning.md#known-rough-edges) — fixing it
...
- **Needed no new data**, unlike P3c's Gap A (deferred 2026-08-14 for lack of a stream-level
  ...
  [02-scoring-and-learning.md](../systems/02-scoring-and-learning.md#known-rough-edges).
...
- **Phase 3a · no-block Today (2026-08-13):** a weekly TSS envelope (Monday-resolved, one-way
  ...
  implementation; see [docs/superpowers/specs/2026-08-12-adaptive-coach-p3a-no-block-today-design.md](../superpowers/specs/2026-08-12-adaptive-coach-p3a-no-block-today-design.md)
  and [docs/superpowers/plans/2026-08-13-adaptive-coach-p3a-no-block-today.md](../superpowers/plans/2026-08-13-adaptive-coach-p3a-no-block-today.md).
...
- **Phase 3b · curated-interval context (PR #48, 2026-08-12):** self-directed intent-matching gains
  ...
  [docs/superpowers/specs/2026-08-12-adaptive-coach-p3b-interval-context-design.md](../superpowers/specs/2026-08-12-adaptive-coach-p3b-interval-context-design.md),
  [docs/superpowers/plans/2026-08-12-adaptive-coach-p3b-interval-context.md](../superpowers/plans/2026-08-12-adaptive-coach-p3b-interval-context.md).
- **Phase 3c · terrain gradient-fallback overmatch fix (PR #51, 2026-08-14, `5c8b473`):** closed a
  ...
  [docs/superpowers/specs/2026-08-14-adaptive-coach-p3c-terrain-fixes-design.md](../superpowers/specs/2026-08-14-adaptive-coach-p3c-terrain-fixes-design.md),
  [docs/superpowers/plans/2026-08-14-adaptive-coach-p3c-terrain-fixes.md](../superpowers/plans/2026-08-14-adaptive-coach-p3c-terrain-fixes.md).
...
Full logic: **[docs/systems/09-nutrition.md](../systems/09-nutrition.md)**. Specs:
...
The season tripwire ([05-season.md](../systems/05-season.md#known-rough-edges)) **fired** and its
...
**Phase A — correctness** ([plan](../superpowers/plans/2026-07-29-block-generation-phase-a-correctness.md), 16 commits).
...
**Phase B — deterministic week skeleton** ([plan](../superpowers/plans/2026-07-29-block-generation-phase-b-skeleton.md), 8 commits).
...
30-min tolerance to 3/4. Details + the traps → [06-generation.md § The week skeleton](../systems/06-generation.md#the-week-skeleton-composition-authority).
...
[design](../superpowers/specs/2026-07-02-ftp-retest-planned-vs-actual-design.md) · plan:
[plan](../superpowers/plans/2026-07-02-ftp-retest-planned-vs-actual.md).
...
[plan](../superpowers/plans/2026-07-02-sub3-route-tests.md).
...
Design/build records: [design](../superpowers/specs/2026-07-02-block-history-durable-corpus-design.md) ·
[plan](../superpowers/plans/2026-07-02-block-history-durable-corpus.md).
...
[goals-weakpoints-centralization](../superpowers/specs/2026-07-01-goals-weakpoints-centralization-design.md) ·
[season-block-hierarchy](../superpowers/specs/2026-07-01-season-block-hierarchy-design.md) ·
[block-completion-prompt](../superpowers/specs/2026-07-01-block-completion-prompt-design.md) ·
[plan](../superpowers/plans/2026-07-01-season-block-goals-flow.md).
...
[season-event-entry-ui](../superpowers/specs/2026-07-01-season-event-entry-ui-design.md).
...
[macro-periodization](../superpowers/specs/2026-07-01-macro-periodization-design.md) ·
[plan](../superpowers/plans/2026-07-01-macro-periodization.md).
...
- **ACC — second-brain state accuracy (athlete request).** Aerobic driver moved off whole-ride decoupling (a
  ...
  Decoupling stays in execution scoring + Trends. _[athlete-state.ts](../../lib/athlete-state.ts) · [nutrition.ts](../../lib/nutrition.ts) · [docs/specs/athlete-state.md](../specs/athlete-state.md)._
