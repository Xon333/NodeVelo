...
> Historical redesign record. Use [DESIGN](../../DESIGN.md), [UX principles](../../UX-CONSTITUTION.md), and [frontend architecture](../systems/08-frontend.md) for current changes; checklists below do not reactivate work.
