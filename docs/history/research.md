...
> Historical research. Claims such as “not implemented” describe the original investigation, not current status. In particular, day-type NEAT calibration is now implemented; see [nutrition](../systems/09-nutrition.md#day-type-calibration-why-rest-maintenance-can-be-higher). Current commitments belong to [ROADMAP](../../ROADMAP.md).
...
Full analysis: **[docs/superpowers/specs/2026-08-01-rest-day-energy-model-review.md](../superpowers/specs/2026-08-01-rest-day-energy-model-review.md)**.
