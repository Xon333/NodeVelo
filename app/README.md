...
- **API routes**: full table in [docs/FILE_INDEX.md](../docs/FILE_INDEX.md#appapi--routes). Routes are IO shells — logic belongs in `lib/` ([recipe](../docs/RECIPES.md#add-an-api-route)).
