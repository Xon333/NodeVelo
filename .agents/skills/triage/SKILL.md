...
These are canonical role names. The actual label strings used in the issue tracker may differ. Read the existing [triage-label mapping](../../../docs/agents/triage-labels.md) and [issue-tracker configuration](../../../docs/agents/issue-tracker.md). Ask only about a material missing value; do not rerun project setup.
